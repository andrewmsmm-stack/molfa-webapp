...
async def handle_quiz_result(message: types.Message):
    ...
    "1️⃣ опануєте безпечну методику роботи з Таро, щоб впевнено проводити розклади без ризику нашкодити собі чи клієнту;\n\n"
    "2️⃣ отримаєте стабільний дохід, опанувавши професію Таролог та отримавши клієнтів на ваші послуги, які я особисто вам передам;\n\n"
    "3️⃣ пізнаєте свої здібності та реалізуєте свою місію допомоги людям через Таро."
)
